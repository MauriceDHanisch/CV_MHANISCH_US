...
{\begin{itemize}
    ...
    \vspace*{0.05cm}
    \item Won \underline{\nth{1} Prize} of the competetion (3000€). Topic: Quantum reservoir computing using only linear optical elements. 
\end{itemize}}
...
\customcventry{Quantum Engineering Hackathon}{05/2023}{ETH Zurich, Switzerland}
{\begin{itemize}
    \item Won \underline{\nth{2} Prize} of the IQM challenge. Topic: Using symmetry-informed quantum machine learning.
\end{itemize}}
