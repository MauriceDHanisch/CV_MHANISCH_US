...
{\begin{itemize}
  \item GPA: 1.28/1.00 (DE). Theoretical physics electives: Foundations of quantum mechanics | Seminar on Bell's inequality, Essay on decoherence.
\end{itemize}
}
\vspace{-0.1cm}
...
{\begin{itemize}
    ...
    \item Investigating the time and space complexity of fermionic and bosonic Gaussian circuits.
    \vspace*{0.15cm}
...
{\begin{itemize}
  \item Teaching Continuum Mechanics and Thermodynamics for \nth{1} year B.Sc. EE students in a weekly in-person class.
  \item Lecturer: Prof. Atac Imamoglu.
\end{itemize}}

\customcventry{Laboratory Supervisor}{10/2021 -- 02/2022}{LMU Munich, Germany}
{\begin{itemize}
  \item Supervising the physics electrodynamic laboratory course for five groups of 20 medicine students.
\end{itemize}}
...
\customcventry{IP Law Intern}{04/2022 -- 04/2022}{Bardehle Pagenberg, Munich, Germany}
{\begin{itemize}
  \item Drafting argumentations for ongoing patent lawsuits. Familiriazition with litigation examples. Supervisor: Sebastian H.-E. Müller.
\end{itemize}}
...
{\begin{itemize}
    \item Won \nth{1} Prize of the competetion (3000€). Worked on Électricité de France (EDF) challenge on quantum reservoir computing using Linear Optics for time series prediction
\end{itemize}}
...
\textbf{Technical:} Python, MATLAB, C\texttt{++}
, LTspice, LaTeX, MS Office, Autodesk Fusion 360, ANSYS Maxwell  
\\
