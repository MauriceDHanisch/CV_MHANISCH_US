...
% personal data directly set
\newcommand{\firstnamee}{Maurice D.}
\newcommand{\familynamee}{Hanisch}
\newcommand{\mytitle}{Resumé}
\newcommand{\myaddress}{Gubelstrasse 44, Zurich, Switzerland}
\newcommand{\mymobile}{+41 763 61 91 83}
\newcommand{\myemail}{mhanisc@student.ethz.ch}
\newcommand{\mylinkedin}{mauricehanisch}
\newcommand{\mygithub}{MauriceDHanisch}
\newcommand{\mybirthdate}{22.08.2000}

\begin{document}
\vspace*{-0.5cm} % Apply this right before your minipage
% Custom title block
\begin{minipage}[t]{0.6\textwidth}
  \raggedright
  {\hspace{-0.05cm}\fontsize{28}{40}\selectfont \bfseries \firstnamee~\familynamee}\\
  \vspace{1em}    
  {\hspace{-0.05cm}\small\faHome~\myaddress}\\
  {\small\faMobile~\href{tel:\mymobile}{\mymobile}}\\
  {\small\faEnvelope~\href{mailto:\myemail}{\myemail}}\\
  \vspace{1em}
  {\small\faLinkedin~\href{https://www.linkedin.com/in/\mylinkedin}{MauriceHanisch}}\\
  {\small\faGithub~\href{https://github.com/\mygithub}{MauriceDHanisch}}\\

  \vspace{1em}
  {\small Birthdate: \mybirthdate}\\
  {\small Nationality: German, French}
\end{minipage}%
\hfill
% Picture block
\begin{minipage}[t]{0.38\textwidth}
  \raggedleft
  \vspace{-\baselineskip} % Adjust vsertical space if necessary
  \vspace{-1.2em}
  \includegraphics[width=0.8\textwidth]{PFP_Cropped.png}
\end{minipage}

\section{Education}
\customcventry{M.Sc. Physics}{09/2022 -- Present}{ETH Zurich, Switzerland}
{\begin{itemize}
    \item Current GPA: 5.77/6.00 (CH).
...
{\begin{itemize}
  ...
  \item Theoretical physics electives: Foundations of Q. Mechanics,  
\end{itemize}
}
\vspace{-0.1cm}
...
\customcventry{Master's Thesis}{09/2023 -- 05/2024}{IBM Quantum, Zurich, Switzerland}
{\begin{itemize}
  \item[] \hspace*{-0.38cm}{\scriptsize \href{https://github.com/quantumjim/soft_information_decoding}{\underline{\faGithub~Project Repo}}}
  \vspace*{0.2cm}
  \item \underline{``Quantum error correction with analog measurement information decoders.''}
  \item Writing soft information decoders in C\texttt{++} \& Python. Analyzing performance on real hardware. Analyzing performance-information trade-off of soft-information decoders.
  \item Skills: C\texttt{++}, Python, IBM Quantum hardware.
  \item Supervisors: Dr. James Wootton, Dr. Joseph Renes, Prof. Renato Renner.
  \item Grade: 6.00/6.00 (CH).
\end{itemize}}
...
\section{Teaching}
\customcventry{Teaching Assistant in Linear Algebra I}{09/2023 -- 02/2024}{ETH Zurich, Switzerland}
{\begin{itemize}
...
{\begin{itemize}
  \item Drafted argumentations for ongoing patent lawsuits. Familiarized with litigation examples. 
  \item Supervisor: Sebastian H.-E. Müller.
\end{itemize}}
